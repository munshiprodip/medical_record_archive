...
@section('script')
    <script>
        ...
        function editData(id) {
            $.ajax({
                url: `{{ route('wards.find', ':id' ) }}`.replace(':id', id),
                type: "GET",
        ...
        edit_data_form.on('submit', function(e) {
            if (!e.isDefaultPrevented()) {
                ...
                $.ajax({
                    url: `{{ route('wards.update', ':id') }}`.replace(':id', id),
                    type: "POST",
        ...
        function changeStatus(id) {
            Swal.fire({
                ...
                if(t.value){
                    $.ajax({
                        url: `{{route('wards.change_status', ':id')}}`.replace(':id', id),
                        type: 'GET',
                        success: function(data) {
                            if (data.success === true) {
                                data_table.ajax.reload();
        ...
        function deleteData(id) {
            Swal.fire({
                ...
                if(t.value){
                    $.ajax({
                        url: `{{route('wards.destroy', ':id')}}`.replace(':id', id),
                        type: 'POST',
                        data: {'_method': 'DELETE',},
                        success: function(data) {
                            if (data.success === true) {
